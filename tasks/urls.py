...
from tasks.views import manager_dashboard,employee_dashboard,task_form,view_task,update_task,delete_task,task_details,dashboard,Greetings,CreateTask,TaskDetail,UpdateTask
urlpatterns = [

...
#         for filed_name in ['username','password1','password2']:
#             self.fields[filed_name].help_text=None
            
class CustomRegisterForm(StyledFormMixin,forms.ModelForm):
    password1=forms.CharField(widget=forms.PasswordInput)
    confirm_password=forms.CharField(widget=forms.PasswordInput) #user form er sathe ei field ta add kore deya holo
    class Meta:
        model=User
    ...
    def clean_password1(self):
        ...
        if len(password1)<8:
           errors.append('Password must 8 digit')
